...
export interface Post {
  ...
  effect?: CoverEffect;
  /**
   * Play only this slice of the narration, looping inside it rather than
   * running the whole chapter. Times are absolute seconds into the mp3, so the
   * captions — which are also absolute — keep working untouched.
   */
