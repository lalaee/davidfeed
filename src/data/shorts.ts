 ...
 * exactly the passage, no windowing is needed — the card just plays and loops.
 * Each carries a `startAt` measured off its own file, so the up-to-1.5s of
 * silence at the head is skipped on entry and on every loop.
 *
 ...
 * see `seconds` below. Nothing is silently trimmed.
 */
...
interface Span {
  ...
  seconds: number;
  /** Measured silence before the first word; omitted when negligible. */
  startAt?: number;
...
const SPANS: Span[] = [
  ...
  { id: 27, verses: "1", seconds: 14.9, startAt: 1.29 },
  { id: 91, verses: "4", seconds: 11.2, startAt: 0.85,
    note: "Chosen over the famous v1-2 because 'shield and rampart' pays off the armoured knight in the artwork." },
  { id: 5, verses: "1-3", seconds: 20.1, startAt: 0.7 },
  { id: 7, verses: "1-2", seconds: 16.7, startAt: 1.03 },
  { id: 16, verses: "11", seconds: 12.2, startAt: 1.17 },
  { id: 20, verses: "7-8", seconds: 16.8, startAt: 1.41,
    note: "Runs through v8 so the chariots/horses contrast actually resolves." },
  { id: 25, verses: "4-5", seconds: 16.0, startAt: 1.03 },
  { id: 3, verses: "1-3", seconds: 20.4, startAt: 1.35,
  ...
  { id: 44, verses: "25-26", seconds: 16.4, startAt: 1.17,
  ...
  { id: 51, verses: "10-12", seconds: 22.2, startAt: 1.22 },
  { id: 4, verses: "6-8", seconds: 23.6, startAt: 1.36 },
];
